...
{
  String url= 'https://maps.googleapis.com/maps/api/place/details/json?place_id=$placeID&name,url,rating,formatted_address,formatted_phone_number&key=${DotEnv().env['APIkey']}';
